...
// Generated 29 ene 2025, 8:55:37 by Hibernate Tools 5.4.33.Final
...
public class Jugador implements java.io.Serializable {
	...
	public Jugador(int idJugador, Equipo equipo, String equipo_1, String nombre, String posicion, int fuerzaAtaque,
			int fuerzaTecnica, int fuerzaDefensa, int fuerzaPortero, boolean seleccionado) {
		this.idJugador = idJugador;
		this.equipo = equipo;
		this.equipo_1 = equipo_1;
		this.nombre = nombre;
	...
	public String toString() {
		return "Jugador [idJugador=" + idJugador + ", equipo=" + equipo + ", equipo_1=" + equipo_1 + ", nombre="
				+ nombre + ", posicion=" + posicion + ", fuerzaAtaque=" + fuerzaAtaque + ", fuerzaTecnica="
				+ fuerzaTecnica + ", fuerzaDefensa=" + fuerzaDefensa + ", fuerzaPortero=" + fuerzaPortero
